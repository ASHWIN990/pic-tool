...
def main():
    ...
    if args.dir == True and args.single == False:
        ...
        if os.path.isdir(args.img):
            if os.name == 'nt':
                dir_image_ext_meta_rem_window(args)
            else:
                dir_image_meta_rem_changer_other(args)
        else:
            print(f"Path {args.img} : is invalid")
...
def dir_image_ext_meta_rem_window(args):
...
def dir_image_meta_rem_changer_other(args):
